      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('kategori.update', $itemkategori->id) }}" method="post">
            ...
            <div class="form-group">
              <label for="rating_peminat">Rating Peminat</label>
              <input type="text" name="rating_peminat" id="rating_peminat" class="form-control" value={{ $itemkategori->rating_peminat}}>
            </div>

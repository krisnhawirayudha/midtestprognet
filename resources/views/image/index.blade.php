              ...
              @foreach($itemkategori as $kategori)
                <tr>
                  ...
                  <td>
                    ...
                    <br>
                    <form action="{{ url('/dashboard/imagekategori/'.$kategori->id) }}" method="post" style="display:inline;">
                      @csrf
                      {{ method_field('delete') }}
                    ...
                    @else
                    <form action="{{ url('/dashboard/imagekategori') }}" method="post" enctype="multipart/form-data" class="form-inline">
                      @csrf
